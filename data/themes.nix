...

{
  themes = {
    catppuccin-mocha = {
      ...
      wallpaper = "./wallpapers/nixos-wallpaper.png";
    ...
    cherry-blossom = {
      name = "cherry-blossom";
      wallpaper = "./wallpapers/cherry.png";
    ...
    nord = {
      name = "nord";
      wallpaper = "./wallpapers/nordnix.png";
    ...
    gruvbox-dark = {
      name = "gruvbox-dark";
      wallpaper = "./wallpapers/gruvnix.png";
    ...
    frutiger-aero = {
      name = "frutiger-aero";
      wallpaper = "./wallpapers/frutiger.jpg";
